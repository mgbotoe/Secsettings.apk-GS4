.class Lcom/android/settings/AccountMenu$IconResizer;
...
.method public constructor <init>(IILandroid/util/DisplayMetrics;)V
    ...
    iput-object v0, p0, Lcom/android/settings/AccountMenu$IconResizer;->mOldBounds:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lcom/android/settings/AccountMenu$IconResizer;->mCanvas:Landroid/graphics/Canvas;

    .line 409
    iget-object v0, p0, Lcom/android/settings/AccountMenu$IconResizer;->mCanvas:Landroid/graphics/Canvas;
    ...
    .line 412
    iput-object p3, p0, Lcom/android/settings/AccountMenu$IconResizer;->mMetrics:Landroid/util/DisplayMetrics;

    .line 413
    iput p1, p0, Lcom/android/settings/AccountMenu$IconResizer;->mIconWidth:I

    .line 414
    iput p2, p0, Lcom/android/settings/AccountMenu$IconResizer;->mIconHeight:I
...
.method public createIconThumbnail(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    iget v0, v0, Lcom/android/settings/AccountMenu$IconResizer;->mIconWidth:I
    ...
    iget v9, v0, Lcom/android/settings/AccountMenu$IconResizer;->mIconHeight:I
    ...
    .line 432
    new-instance v20, Lcom/android/settings/AccountMenu$EmptyDrawable;

    move-object/from16 v0, v20

    move/from16 v1, v17

    invoke-direct {v0, v1, v9}, Lcom/android/settings/AccountMenu$EmptyDrawable;-><init>(II)V
    ...
    iget v0, v0, Lcom/android/settings/AccountMenu$IconResizer;->mIconHeight:I
    ...
    iget-object v8, v0, Lcom/android/settings/AccountMenu$IconResizer;->mCanvas:Landroid/graphics/Canvas;
    ...
    iget-object v0, v0, Lcom/android/settings/AccountMenu$IconResizer;->mOldBounds:Landroid/graphics/Rect;
    ...
    iget-object v0, v0, Lcom/android/settings/AccountMenu$IconResizer;->mMetrics:Landroid/util/DisplayMetrics;
    ...
    :goto_5
    new-instance p1, Lcom/android/settings/AccountMenu$EmptyDrawable;

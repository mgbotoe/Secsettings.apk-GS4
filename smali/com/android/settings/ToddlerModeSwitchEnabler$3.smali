...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object v4, p0, Lcom/android/settings/ToddlerModeSwitchEnabler$3;->this$0:Lcom/android/settings/ToddlerModeSwitchEnabler;

    #getter for: Lcom/android/settings/ToddlerModeSwitchEnabler;->mContext:Landroid/content/Context;
    invoke-static {v4}, Lcom/android/settings/ToddlerModeSwitchEnabler;->access$100(Lcom/android/settings/ToddlerModeSwitchEnabler;)Landroid/content/Context;
    ...
    #getter for: Lcom/android/settings/ToddlerModeSwitchEnabler;->mContext:Landroid/content/Context;
    invoke-static {v0}, Lcom/android/settings/ToddlerModeSwitchEnabler;->access$100(Lcom/android/settings/ToddlerModeSwitchEnabler;)Landroid/content/Context;
    ...
    iget-object v3, p0, Lcom/android/settings/ToddlerModeSwitchEnabler$3;->this$0:Lcom/android/settings/ToddlerModeSwitchEnabler;

    #getter for: Lcom/android/settings/ToddlerModeSwitchEnabler;->mContext:Landroid/content/Context;
    invoke-static {v3}, Lcom/android/settings/ToddlerModeSwitchEnabler;->access$100(Lcom/android/settings/ToddlerModeSwitchEnabler;)Landroid/content/Context;
    ...
    :goto_1
    #calls: Lcom/android/settings/ToddlerModeSwitchEnabler;->setMode(Z)V
    invoke-static {v0, v1}, Lcom/android/settings/ToddlerModeSwitchEnabler;->access$300(Lcom/android/settings/ToddlerModeSwitchEnabler;Z)V

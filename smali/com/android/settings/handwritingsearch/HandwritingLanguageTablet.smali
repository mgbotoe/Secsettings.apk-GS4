...
.method private getDescriptionString()Ljava/lang/String;
    ...
    .prologue
    const v11, 0x7f0915b3

    const v10, 0x7f0915b2
    ...
    iget-object v5, p0, Lcom/android/settings/handwritingsearch/HandwritingLanguageTablet;->mHandwritingLanguageListAdapter:Lcom/android/settings/handwritingsearch/HandwritingLanguageTablet$HandwritingLanguageListAdapter;

    iget-object v6, p0, Lcom/android/settings/handwritingsearch/HandwritingLanguageTablet;->mListView:Landroid/widget/ListView;

    invoke-virtual {v6}, Landroid/widget/ListView;->getCheckedItemPosition()I

    move-result v6

    invoke-virtual {v5, v6}, Lcom/android/settings/handwritingsearch/HandwritingLanguageTablet$HandwritingLanguageListAdapter;->getItem(I)Lcom/android/settings/handwritingsearch/HandwritingLanguageTablet$LanguageInfo;

    move-result-object v5

    invoke-virtual {v5}, Lcom/android/settings/handwritingsearch/HandwritingLanguageTablet$LanguageInfo;->getLanguage()Ljava/lang/String;
    ...
    .line 178
    .local v4, zhLocale:Ljava/util/Locale;
    if-nez v0, :cond_0
    ...
    const-string v3, "\u30a2\u30eb\u30d5\u30a1\u30d9\u30c3\u30c8"

    .line 187
    .local v3, lang1:Ljava/lang/String;
    :goto_1
    iget-object v5, p0, Lcom/android/settings/handwritingsearch/HandwritingLanguageTablet;->mContext:Landroid/content/Context;
    ...
    .line 186
    .end local v3           #lang1:Ljava/lang/String;
    :cond_3
...
.method public static getLocaleInfoAdapter(Landroid/content/Context;[Ljava/lang/String;)[Lcom/android/settings/handwritingsearch/HandwritingLanguageTablet$LanguageInfo;
    ...
    .line 352
    .local v21, preprocess:[Lcom/android/settings/handwritingsearch/HandwritingLanguageTablet$LanguageInfo;
    const/4 v8, 0x0
    ...
    .line 448
    .local v23, retLanguage:[Lcom/android/settings/handwritingsearch/HandwritingLanguageTablet$LanguageInfo;
    move-object/from16 v0, v17
...
.method public onResume()V
    ...
    invoke-direct {v5, p0, v6, v7, v0}, Lcom/android/settings/handwritingsearch/HandwritingLanguageTablet$HandwritingLanguageListAdapter;-><init>(Lcom/android/settings/handwritingsearch/HandwritingLanguageTablet;Landroid/content/Context;I[Lcom/android/settings/handwritingsearch/HandwritingLanguageTablet$LanguageInfo;)V
